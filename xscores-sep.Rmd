...
url of http://old.xscores.com/soccer/soccer.jsp?menu3=5 seems to do it
...
"Crb", "Bsu", "Jk", "Pfc", "Shb", "Scr", "Pss", "Pkns", "Ptt", "Cp", "Rb", "Bsc"
)
...
d5 %>% mutate_at(vars(starts_with("team")), ~casify(.,changes))  %>% 
  View("Scores")
```
